...
Java_com_mqttai_chat_tools_LlamaInference_loadModel(JNIEnv *env, jobject, jstring jpath) {
...
Java_com_mqttai_chat_tools_LlamaInference_complete(JNIEnv *env, jobject, jstring jprompt, jint maxTokens) {
...
Java_com_mqttai_chat_tools_LlamaInference_unloadModel(JNIEnv *, jobject) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_mqttai_chat_tools_LlamaInference_isLoaded(JNIEnv *, jobject) {
